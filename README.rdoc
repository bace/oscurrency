...
The notes below are for Insoshi. SFBace has deviated from Isoshi in many respects, which are mostly undocuments.  You can use the guidelines below judiciously.
